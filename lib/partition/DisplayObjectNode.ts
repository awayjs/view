...
export class DisplayObjectNode extends AbstractionBase implements INode
{
	...
	constructor(entity:DisplayObject, pool:IAbstractionPool)
	{
		...
		this._entity = entity;
		this._entity.addEventListener(DisplayObjectEvent.INVALIDATE_BOUNDS, this._onInvalidateBoundsDelegate);
	}
	...
	public onClear(event:AssetEvent):void
	{
		...
		this._entity.removeEventListener(DisplayObjectEvent.INVALIDATE_BOUNDS, this._onInvalidateBoundsDelegate);
		this._entity = null;
	}
